								...
								<tbody>
									<c:forEach var="user" items="${userList}" varStatus="status">
										<tr>
											<td>${user.id}</td>
											<td>${user.email}</td>
											<td><a href="/edit?id=${user.id}"><button
														class="btn btn-warning btn-flat margin">Edit</button></a><a
												href="/delete?id=${user.id}"><button
														class="btn btn-danger btn-flat margin">Delete</button></a></td>
										</tr>
									</c:forEach>
								</tbody>
								<tfoot>
