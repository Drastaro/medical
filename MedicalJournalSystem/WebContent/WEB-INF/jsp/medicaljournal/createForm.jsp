...
<body>
	...
	<section class="content-header">
		<h1>Upload New Medical Journal</h1>
	</section>
				...
				<div class="box box-primary">
					<div class="box-header">
						...
						<form:form method="post" modelAttribute="journal"
							action="${saveAction}?${_csrf.parameterName}=${_csrf.token}"
							...
							<div class="box-body">
								<div class="form-group">
									...
									<form:input type="text" class="form-control" id="title"
										name="title" placeholder="Enter journal title" path="title" />
								</div>
								<div class="form-group">
									<label for="description">Description</label>
									<form:input type="text" class="form-control" id="description"
										name="description" placeholder="Enter journal description"
										path="description" />
								</div>
								<div class="form-group">
									<label for="inputFile">Journal file (*.pdf)</label>
									<form:input type="file" id="inputFile" path="pdfFile" />
								</div>
								<!-- Date range -->
								<div class="form-group">
							...
							<div class="box-footer">
								...
								<a
									...
									class="btn btn-warning">Back to list</a>
							</div>
						</form:form>
					</div>
				</div>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/plugins/daterangepicker/daterangepicker.js"></script>
	<script
