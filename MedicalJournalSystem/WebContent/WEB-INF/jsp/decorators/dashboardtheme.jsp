				...
				<ul class="sidebar-menu">
					...
					<li><a
						href="${pageContext.request.contextPath}/medicaljournals/search">
							<i class="fa fa-user" aria-hidden="true"></i><span>Medical Journals Search</span>
					</a></li>
					<li><a
						href="${pageContext.request.contextPath}/medicaljournals/list">
							<i class="fa fa-user" aria-hidden="true"></i><span>Medical Journals Admin</span>
					</a></li>
					
					<li><a href="${pageContext.request.contextPath}/users/list">
							<i class="fa fa-user" aria-hidden="true"></i><span>Users admin</span>
					</a></li>
